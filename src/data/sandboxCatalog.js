...
const KO_ISSUE_NAMES = {
  ...
  service_vuln_host_medium: '취약점 보유 호스트 노출(중간)',
  service_vuln_host_v3_critical: '취약점 보유 호스트 노출(심각)',
  service_vuln_host_v3_high: '취약점 보유 호스트 노출(높음)',
  service_vuln_host_v3_low: '취약점 보유 호스트 노출(낮음)',
  patching_cadence_v3_critical: '치명적 취약점 미패치(Critical)',
  patching_cadence_v3_high: '심각 취약점 미패치(High)',
  patching_cadence_v3_medium: '취약점 미패치(Medium)',
  patching_cadence_high: '취약점 미패치(High)',
  outdated_browser: '지원 종료 브라우저 접속 허용',
  pva_installation_trail: '취약 가능 애플리케이션 설치 흔적',
  cdn_hosting: 'CDN 호스팅 사용',
